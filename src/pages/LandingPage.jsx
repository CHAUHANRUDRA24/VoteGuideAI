...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-bg-dark relative overflow-x-hidden">
      ...
      {/* ====== WHAT WE DO ====== */}
      <section className="relative z-10 px-5 py-20 bg-bg-card/20 border-t border-border/30">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
            <p className="text-xs text-primary font-semibold uppercase tracking-widest mb-2">Our Mission</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-text-primary">What We Do</h2>
            <p className="text-text-muted text-sm sm:text-base mt-4 leading-relaxed">
              We aim to simplify the Indian voting process by providing an accessible, AI-powered election assistant. 
              Our platform bridges the gap between voters and official Election Commission of India (ECI) procedures, 
              ensuring every citizen has the knowledge and confidence to participate in the democratic process.
              By leveraging AI, we break down language barriers and deliver personalized, step-by-step guidance.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      {/* ====== FEATURES ====== */}
      <section className="relative z-10 px-5 py-20 border-t border-border/30">
